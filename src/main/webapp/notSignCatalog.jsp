...
<body>
  ...
  <ol class = "ca">
	<%--<li><div><a class="book" href="notSignInfoBook.html">Война и мир.</a></div></li>--%>
	<%--<li><div><a class="book" href="notSignInfoBook.html">Шерлок Холмс.</a> </div> </li>--%>
	<%--<li><div><a class="book" href="notSignInfoBook.html">Гарри Поттер (Часть 6). </a></div></li>--%>
    ${books}
  </ol>
